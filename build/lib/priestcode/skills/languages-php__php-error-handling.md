...
description: Handle errors correctly in PHP — the right mechanism, no swallowed failures.
category: languages/php
tags: [php, errors, exceptions]
---
# PHP error handling

## When to use
Any PHP code that can fail (I/O, parsing, network, external calls).
