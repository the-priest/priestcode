---
name: PHP idioms & style
description: Write idiomatic, readable PHP the way its community expects.
category: languages/php
tags: [php, idioms, style]
---
# PHP idioms & style

## When to use
Writing or reviewing PHP that should look native to the language.

## Checklist
- Follow the language's official style guide and formatter.
