...
description: Handle errors correctly in Kotlin — the right mechanism, no swallowed failures.
category: languages/kotlin
tags: [kotlin, errors, exceptions]
---
# Kotlin error handling

## When to use
Any Kotlin code that can fail (I/O, parsing, network, external calls).
