...
description: Handle errors correctly in Rust — the right mechanism, no swallowed failures.
category: languages/rust
tags: [rust, errors, exceptions]
---
# Rust error handling

## When to use
Any Rust code that can fail (I/O, parsing, network, external calls).
