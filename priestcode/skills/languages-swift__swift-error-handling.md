...
description: Handle errors correctly in Swift — the right mechanism, no swallowed failures.
category: languages/swift
tags: [swift, errors, exceptions]
---
# Swift error handling

## When to use
Any Swift code that can fail (I/O, parsing, network, external calls).
